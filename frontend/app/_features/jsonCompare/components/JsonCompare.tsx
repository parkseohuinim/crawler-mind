            ...
            <div className="file-upload-section">
              <div className="file-upload-grid">
                <div className="file-upload-item">
                  ...
                  <div 
                    className={`file-input-wrapper ${dragOverFile1 ? 'dragover' : ''}`}
                  ...
                  >
                    ...
                    />
                    <div 
                      className={`file-input-button ${isComparing ? 'disabled' : ''}`}
                      onClick={() => !isComparing && file1Ref.current?.click()}
                    >
                      <img 
                ...
                <div className="file-upload-item">
                  ...
                  <div 
                    className={`file-input-wrapper ${dragOverFile2 ? 'dragover' : ''}`}
                  ...
                  >
                    ...
                    <div 
                      className={`file-input-button ${isComparing ? 'disabled' : ''}`}
                      onClick={() => !isComparing && file2Ref.current?.click()}
                    >
                      <img 
                        src="/icons/upload-file-document-svgrepo-com.svg" 
                        alt="업로드" 
